...
import { BASE_Y, BUILDINGS } from "./skyline-data";
 ...
 * tirage déterministe et la perspective atmosphérique.
 *
 ...
 */
export default function Skyline({ windowsLit }: Props) {
  return (
    <group>
      ...
      {BUILDINGS.map(({ x, width, top, z, color }, i) => (
